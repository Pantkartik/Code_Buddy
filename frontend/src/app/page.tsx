    ...
    <div className="min-h-screen bg-[#000000] text-zinc-300 font-sans selection:bg-zinc-800 overflow-x-hidden">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center pt-20 pb-32 border-x border-dashed border-zinc-800 relative">
          ...
          <div className="mt-32 border-y border-dashed border-zinc-800 bg-[#050505] overflow-hidden whitespace-nowrap py-12 relative">
            <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-[#000] to-transparent z-10" />
            <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-[#000] to-transparent z-10" />
            
            <div className="flex animate-marquee hover:[animation-play-state:paused]">
              {[...Array(2)].map((_, i) => (
                <div key={i} className="flex shrink-0">
                  {[
                    { name: "@alex_dev", text: "Best pair programming matching I've ever used. The tech stack filtering is elite." },
                    { name: "@sara_tech", text: "Found my long-term co-founder here. CodeBuddy is a game changer for builders." },
                    { name: "@mike_codes", text: "The brutalist UI is so refreshing. No fluff, just pure engineering velocity." },
                    { name: "@lina_js", text: "Streaks kept me motivated through my 100 days of code challenge. Love the XP system." },
                  ].map((t, idx) => (
                    <div key={idx} className="flex flex-col mx-8 bg-zinc-900/40 border border-zinc-800 p-6 min-w-[300px] whitespace-normal">
                      <p className="text-zinc-400 text-sm mb-4">"{t.text}"</p>
          ...
          {/* Call to Action */}
          <div className="mt-32 mb-32 text-center p-12 border border-dashed border-zinc-800 relative bg-[#050505] group">
            <Plus className="w-4 h-4 text-zinc-600 absolute -left-2 -top-2" />
            <Plus className="w-4 h-4 text-zinc-600 absolute -right-2 -top-2" />
            ...
            <h2 className="text-4xl font-bold text-white mb-6 tracking-tighter">Ready to scale your code?</h2>
            <p className="text-zinc-500 mb-10 max-w-lg mx-auto">Join a collective of high-velocity engineers shipping the future of the web.</p>
            <Link
              href="/register"
              className="inline-flex items-center gap-2 bg-white text-black px-8 py-4 text-sm font-semibold transition-all hover:bg-zinc-200 border border-white"
            >
          ...
          {/* Footer Component */}
          <footer className="mt-auto pt-20 border-t border-dashed border-zinc-800">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
              <div className="col-span-1 md:col-span-2">
                <div className="flex items-center gap-3 font-semibold text-white tracking-tight mb-6">
                  <div className="bg-white text-black p-1 rounded-sm">
                    <Terminal className="w-4 h-4" strokeWidth={3} />
                  </div>
                  CodeBuddy
                ...
                <p className="text-zinc-500 text-sm max-w-sm leading-relaxed font-light">
                  An open-source matching engine for high-velocity engineers. Built by the community, for the community.
                </p>
              </div>
              
              <div>
                <h4 className="text-white text-sm font-semibold mb-6 uppercase tracking-widest">Resources</h4>
                <ul className="space-y-4">
                  <li><Link href="#" className="text-zinc-500 text-sm hover:text-white transition-colors">Documentation</Link></li>
                  <li><Link href="#" className="text-zinc-500 text-sm hover:text-white transition-colors">API Reference</Link></li>
                  <li><Link href="#" className="text-zinc-500 text-sm hover:text-white transition-colors">GitHub</Link></li>
                </ul>
              </div>

              <div>
                <h4 className="text-white text-sm font-semibold mb-6 uppercase tracking-widest">Platform</h4>
                <ul className="space-y-4">
                  <li><Link href="/login" className="text-zinc-500 text-sm hover:text-white transition-colors">Sign In</Link></li>
                  <li><Link href="/register" className="text-zinc-500 text-sm hover:text-white transition-colors">Create Account</Link></li>
                  <li><Link href="/premium" className="text-zinc-500 text-sm hover:text-white transition-colors">Enterprise</Link></li>
                </ul>
              </div>
            </div>

            <div className="flex flex-col md:flex-row justify-between items-center py-10 border-t border-dashed border-zinc-900">
              <span className="text-zinc-600 text-xs font-mono">© 2024 CODEBUDDY.IO — SYSTEMS OPERATIONAL</span>
              <div className="flex gap-8 mt-4 md:mt-0">
                <a href="#" className="text-zinc-600 text-xs hover:text-zinc-400 transition-colors uppercase tracking-widest">Twitter</a>
                <a href="#" className="text-zinc-600 text-xs hover:text-zinc-400 transition-colors uppercase tracking-widest">Discord</a>
                <a href="#" className="text-zinc-600 text-xs hover:text-zinc-400 transition-colors uppercase tracking-widest">Status</a>
              </div>
            </div>
          </footer>
